    ...
    if (fs.existsSync(DEFAULT_CONFIG)) {
        try {
            ...
            if (defaultConfig.gateway) {
                ...
                config.gateway.controlUi = config.gateway.controlUi || defaultConfig.gateway.controlUi || {};
                config.gateway.auth = config.gateway.auth || defaultConfig.gateway.auth || {};
                config.gateway.trustedProxies = config.gateway.trustedProxies || defaultConfig.gateway.trustedProxies || [];
